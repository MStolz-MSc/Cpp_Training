...
public:
  ...
  ~Computer();
  // Destructor
  void setspeed ( int p ); // prototype function;
  int readspeed();         // prototype function;
protected:
...
void Computer::setspeed ( int p )
{
  ...
  //  of the function.
  processorspeed = p; // setting value to processorspeed only through access
                      // by the functions inside public area of the class
}
int Computer::readspeed() // defining the function inside the class from the outside of a class
{
